...
#						}
					...
					#} elsif($format_value =~ /AD/) { # We've got a VCF of POOL; we need AD and DP
						...
						my $prior_to_RD;
						my @colons_prior_to_RD;
						my $colon_count_before_RD;

						if($format_value =~ /RD/) {
							$prior_to_RD = $`;
						}
						
						@colons_prior_to_RD = $prior_to_RD =~ /\:/g; 
						$colon_count_before_RD = @colons_prior_to_RD;
						#print "\n\nColon count before RD: $colon_count_before_RD\n";
						...
						if ($format_value =~ /RD/ && $sample_value_arr[$colon_count_before_AD] =~ /(\d+)\,(\d+)\,(\d+)/){ #REF count specified in own format row
							$AD1 = $sample_value_arr[$colon_count_before_RD];
							$AD2 = $1;
							$AD3 = $2;
							$AD4 = $3;
						} elsif($sample_value_arr[$colon_count_before_AD] =~ /(\d+)\,(\d+)\,(\d+)\,(\d+)/) { # REF and 3 ALTS
							$AD1 = $1;
							$AD2 = $2;
							$AD3 = $3;
							$AD4 = $4;
...
#						}
					...
					#} elsif($format_value =~ /AD/) { # We've got a VCF of POOL; we need AD and DP
						...
						if ($format_value =~ /RD/ && $sample_value_arr[$colon_count_before_AD] =~ /(\d+)\,(\d+)/){ #REF count specified in own format row
							$AD1 = $sample_value_arr[$colon_count_before_RD];
							$AD2 = $1;
							$AD3 = $2;
						} elsif($sample_value_arr[$colon_count_before_AD] =~ /(\d+)\,(\d+)\,(\d+)/) { # REF and 2 ALTS
							$AD1 = $1;
							$AD2 = $2;
							$AD3 = $3;
						} elsif($sample_value_arr[$colon_count_before_AD] =~ /\./) {
...
#						}
					...
					#} elsif($format_value =~ /AD/) { # We've got a VCF of POOL; we need AD and DP
						...
						if ($format_value =~ /RD/ && $sample_value_arr[$colon_count_before_AD] =~ /(\d+)/){ #REF count specified in own format row
							$AD1 = $sample_value_arr[$colon_count_before_RD];
							$AD2 = $sample_value_arr[$colon_count_before_AD];
						} elsif($sample_value_arr[$colon_count_before_AD] =~ /(\d+)\,(\d+)/) { # REF and 1 ALT
							$AD1 = $1;
							$AD2 = $2;
						} elsif($sample_value_arr[$colon_count_before_AD] =~ /\./) {
							print "\n### WARNING: for ID $id_value\, the value of AD contains \"\.\". Record ignored.\n";
